...
I think that _Sleeping At Last_ songs in general are more calm than the other songs in the corpus. Moreover, I think that the use of specific instruments that are not used a lot in the rest of the corpus will make the songs sound different from the other songs. 

In the other tabs, analysis and information can be found about feeling, sound and tempo of _Sleeping At Last_ songs. 
The findings that were found during the analysis are summarized in the conclusion section, where the corpus will also be tried to be grouped according to these conclusions.
...
<!-- # What characteristics do _Sleeping At Last_ songs have? {data-icon="fa-music"} -->
